	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'inner-glow': 'inset 0 0 10px rgba(155, 135, 245, 0.2)',
			},
			backgroundImage: {
				...
				'gradient-purple': 'linear-gradient(90deg, #9b87f5, #7E69AB)',
				'gradient-blue-purple': 'linear-gradient(90deg, #3B82F6, #8B5CF6)',
			},
		}
	},
